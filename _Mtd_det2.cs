...
namespace DLL_test1
{
    public class _Mtd_det2
    {
        ...
        public DataSet trans_dataset(string sqlq)
        {
            ...
            SqlCommand cmd2 = new SqlCommand(sqlq, conn, trans);
            ...
            try
            {
                ...
                reader1.Close(); trans.Commit(); conn.Close();
            }
            catch (Exception ex)
            {
                trans.Rollback();
        ...
        public string sql_transaction(string sqlq)
        {
            conn.Open();
            SqlTransaction trans = conn.BeginTransaction("test");
            SqlCommand cmd2 = new SqlCommand(sqlq, conn, trans);
            ...
            try
            {
                conn.InfoMessage += (object obj, SqlInfoMessageEventArgs e) => SQL_print = e.Message;
        ...
        public bool EjecutarSP(string nombreSP, SqlParameter[] parametroSP)
        {
            try
            {
                ...
                SqlCommand cmd2 = new SqlCommand(nombreSP, conn);
        ...
        public DataSet EjecutarSP_dataset(string nombreSP, SqlParameter[] parametroSP)
        {
            DS_remove();
            ...
            try
            {
                ...
                conn.Close(); Dt.Fill(_Ds);
                return _Ds;
            }
            catch (Exception ex)
            {
                conn.Close(); return _Ds;
            }
        }
